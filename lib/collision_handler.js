    ...
    detectCollisions() {
        ...
        for (const [entityA, entityB] of potentialCollisions) {
            ...
            for(let i = 0; i < axes.length; i++) {
                ...
                const radiusA = this.projectRaduis(entityA.obb, axis);
                const radiusB = this.projectRaduis(entityB.obb, axis);
            ...
            const radiusA = this.projectRaduis(entityA.obb, normal);
            const radiusB = this.projectRaduis(entityB.obb, normal);
